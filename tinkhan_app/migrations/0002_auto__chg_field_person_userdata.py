...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Person.userdata'
        db.alter_column('tinkhan_app_person', 'userdata_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['khan.UserData'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Person.userdata'
        raise RuntimeError("Cannot reverse this migration. 'Person.userdata' and its values cannot be restored.")
