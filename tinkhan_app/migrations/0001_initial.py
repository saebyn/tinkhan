...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tinkhan_app_userprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('tcapi_endpoint', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['tincan_exporter.TinCanEndpoint'], unique=True, null=True, blank=True)),
            ('company', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True)),
        ))
        db.send_create_signal('tinkhan_app', ['UserProfile'])

        # Adding model 'Person'
        db.create_table('tinkhan_app_person', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tinkhan_app.UserProfile'])),
            ('userdata', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['khan.UserData'])),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('use_tc_account', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('tc_account_homePage', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('tc_account_id', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal('tinkhan_app', ['Person'])


    def backwards(self, orm):
        # Deleting model 'UserProfile'
        db.delete_table('tinkhan_app_userprofile')

        # Deleting model 'Person'
        db.delete_table('tinkhan_app_person')
    ...
    models = {
        ...
        'tinkhan_app.person': {
            ...
            'userdata': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['khan.UserData']"})
        },
