...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Performance.last_done'
        db.alter_column('khan_performance', 'last_done', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Performance.last_review'
        db.alter_column('khan_performance', 'last_review', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Performance.first_done'
        db.alter_column('khan_performance', 'first_done', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Performance.last_done'
        raise RuntimeError("Cannot reverse this migration. 'Performance.last_done' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Performance.last_review'
        raise RuntimeError("Cannot reverse this migration. 'Performance.last_review' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Performance.first_done'
        raise RuntimeError("Cannot reverse this migration. 'Performance.first_done' and its values cannot be restored.")
