...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Topic.khan_id'
        db.alter_column('khan_topic', 'khan_id', self.gf('django.db.models.fields.SlugField')(max_length=255))

        # Changing field 'Video.khan_id'
        db.alter_column('khan_video', 'khan_id', self.gf('django.db.models.fields.SlugField')(max_length=255))

        # Changing field 'Exercise.khan_id'
        db.alter_column('khan_exercise', 'khan_id', self.gf('django.db.models.fields.SlugField')(max_length=255))

        # Changing field 'Badge.khan_id'
        db.alter_column('khan_badge', 'khan_id', self.gf('django.db.models.fields.SlugField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Topic.khan_id'
        db.alter_column('khan_topic', 'khan_id', self.gf('django.db.models.fields.SlugField')(max_length=50))

        # Changing field 'Video.khan_id'
        db.alter_column('khan_video', 'khan_id', self.gf('django.db.models.fields.SlugField')(max_length=50))

        # Changing field 'Exercise.khan_id'
        db.alter_column('khan_exercise', 'khan_id', self.gf('django.db.models.fields.SlugField')(max_length=50))

        # Changing field 'Badge.khan_id'
        db.alter_column('khan_badge', 'khan_id', self.gf('django.db.models.fields.SlugField')(max_length=50))
    ...
    models = {
        ...
        'khan.badge': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'khan_id': ('django.db.models.fields.SlugField', [], {'max_length': '255'}),
