...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Video.position'
        db.alter_column('khan_video', 'position', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Video.position'
        raise RuntimeError("Cannot reverse this migration. 'Video.position' and its values cannot be restored.")
