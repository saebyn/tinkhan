...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Performance.summative'
        db.add_column('khan_performance', 'summative',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Performance.seconds_per_fast_problem'
        db.add_column('khan_performance', 'seconds_per_fast_problem',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


        # Changing field 'Performance.proficient_date'
        db.alter_column('khan_performance', 'proficient_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Exercise.seconds_per_fast_problem'
        db.alter_column('khan_exercise', 'seconds_per_fast_problem', self.gf('django.db.models.fields.FloatField')())
        # Adding index on 'UserData', fields ['user_id']
        db.create_index('khan_userdata', ['user_id'])

        # Adding unique constraint on 'UserData', fields ['user_id']
        db.create_unique('khan_userdata', ['user_id'])

        # Adding index on 'BadgeCategory', fields ['khan_id']
        db.create_index('khan_badgecategory', ['khan_id'])

        # Adding unique constraint on 'BadgeCategory', fields ['khan_id']
        db.create_unique('khan_badgecategory', ['khan_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'BadgeCategory', fields ['khan_id']
        db.delete_unique('khan_badgecategory', ['khan_id'])

        # Removing index on 'BadgeCategory', fields ['khan_id']
        db.delete_index('khan_badgecategory', ['khan_id'])

        # Removing unique constraint on 'UserData', fields ['user_id']
        db.delete_unique('khan_userdata', ['user_id'])

        # Removing index on 'UserData', fields ['user_id']
        db.delete_index('khan_userdata', ['user_id'])

        # Deleting field 'Performance.summative'
        db.delete_column('khan_performance', 'summative')

        # Deleting field 'Performance.seconds_per_fast_problem'
        db.delete_column('khan_performance', 'seconds_per_fast_problem')


        # User chose to not deal with backwards NULL issues for 'Performance.proficient_date'
        raise RuntimeError("Cannot reverse this migration. 'Performance.proficient_date' and its values cannot be restored.")

        # Changing field 'Exercise.seconds_per_fast_problem'
        db.alter_column('khan_exercise', 'seconds_per_fast_problem', self.gf('django.db.models.fields.IntegerField')())
