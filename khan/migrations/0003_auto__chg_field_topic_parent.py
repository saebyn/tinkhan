...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Topic.parent'
        db.alter_column('khan_topic', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['khan.Topic']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Topic.parent'
        raise RuntimeError("Cannot reverse this migration. 'Topic.parent' and its values cannot be restored.")
