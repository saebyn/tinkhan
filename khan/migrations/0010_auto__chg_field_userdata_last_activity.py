...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserData.last_activity'
        db.alter_column('khan_userdata', 'last_activity', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'UserData.last_activity'
        raise RuntimeError("Cannot reverse this migration. 'UserData.last_activity' and its values cannot be restored.")
