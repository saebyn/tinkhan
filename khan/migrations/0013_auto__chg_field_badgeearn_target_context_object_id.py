...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BadgeEarn.target_context_object_id'
        db.alter_column('khan_badgeearn', 'target_context_object_id', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'BadgeEarn.target_context_object_id'
        raise RuntimeError("Cannot reverse this migration. 'BadgeEarn.target_context_object_id' and its values cannot be restored.")
    ...
    models = {
        ...
        'khan.badgeearn': {
            ...
            'target_context_object_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
