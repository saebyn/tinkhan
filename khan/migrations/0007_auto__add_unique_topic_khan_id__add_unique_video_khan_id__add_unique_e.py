...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Topic', fields ['khan_id']
        db.create_unique('khan_topic', ['khan_id'])

        # Adding unique constraint on 'Video', fields ['khan_id']
        db.create_unique('khan_video', ['khan_id'])

        # Adding unique constraint on 'Exercise', fields ['khan_id']
        db.create_unique('khan_exercise', ['khan_id'])

        # Adding unique constraint on 'Badge', fields ['khan_id']
        db.create_unique('khan_badge', ['khan_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Badge', fields ['khan_id']
        db.delete_unique('khan_badge', ['khan_id'])

        # Removing unique constraint on 'Exercise', fields ['khan_id']
        db.delete_unique('khan_exercise', ['khan_id'])

        # Removing unique constraint on 'Video', fields ['khan_id']
        db.delete_unique('khan_video', ['khan_id'])

        # Removing unique constraint on 'Topic', fields ['khan_id']
        db.delete_unique('khan_topic', ['khan_id'])
